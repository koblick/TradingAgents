...
class GraphSetup:
    ...
    def setup_graph(
        ...
        workflow.add_node(
            "Aggressive Analyst",
            self._wrap_node("Aggressive Analyst", aggressive_analyst),
        )
        workflow.add_node(
        ...
        workflow.add_node(
            ...
            self._wrap_node("Conservative Analyst", conservative_analyst),
        )
        workflow.add_node(
            "Portfolio Manager",
            self._wrap_node("Portfolio Manager", portfolio_manager_node),
        )
